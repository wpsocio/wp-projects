...
$generated_i18n_strings = array(
	...
	// Reference: js/settings/services/fields.ts:10
	__( 'Exclude', 'wptelegram-comments' ),

	// Reference: js/settings/services/fields.ts:11
	...
	// Reference: js/settings/ui/Instructions.tsx:31
	/* translators: 1 menu name, 2, 3 buttons */
	__( 'Under %1$s click on %2$s or %3$s.', 'wptelegram-comments' ),

	// Reference: js/settings/ui/Instructions.tsx:47
